...
function PANEL:Populate(player, report)
	...
	function button.DoClick(button)
		...
		if (IsValid(player)) then
			Clockwork.datastream:Start( "EditReport", { player, string.sub(textEntry:GetValue(), 0, 500) } );
		end;
...
vgui.Register("cwReport", PANEL, "DFrame");