...
function ENT:SpawnFunction( ply, tr, faction )
	...
	self:SetNWString("parentPos-"..self:GetCreationID(), ent2:GetAngles());
	ent2:SetNWString("parentPos-"..ent2:GetCreationID(), self:GetAngles());
...
function ENT:Use(player)
	...
	target:SetNWString("parentAngles-"..target:GetCreationID(), parent:GetAngles());
	parent:SetNWString("parentAngles-"..parent:GetCreationID(), target:GetAngles());
