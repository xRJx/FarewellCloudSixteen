...
function THEME:CreateFonts()
	...
	surface.CreateFont("hlc_ThickArial", 
	{
		font		= "Arial",
	...
	surface.CreateFont("hlc_PlayerInfoText", 
	{
		font		= "Verdana",
		size		= Clockwork.kernel:FontScreenScale(7),
		weight		= 600,
	...
	surface.CreateFont("hlc_Large3D2D", 
	{
		font		= "Dirty Ego",
	...
	surface.CreateFont("hlc_IntroTextSmall", 
	{
		font		= "Dirty Ego",
	...
	surface.CreateFont("hlc_IntroTextTiny", 
	{
		font		= "Dirty Ego",
	...
	surface.CreateFont("hlc_CinematicText", 
	{
		font		= "Dirty Ego",
	...
	surface.CreateFont("hlc_IntroTextBig", 
	{
		font		= "Dirty Ego",
	...
	surface.CreateFont("hlc_MainText", 
	{
		font		= "Dirty Ego",
		size		= Clockwork.kernel:FontScreenScale(13),
		weight		= 600,
	...
	surface.CreateFont("hlc_TargetIDText", 
	{
		font		= "Verdana",
		size		= Clockwork.kernel:FontScreenScale(7),
		weight		= 600,
	...
	surface.CreateFont("hlc_MenuTextHuge", 
	{
		font		= "Dirty Ego",
	...
	surface.CreateFont("hlc_MenuTextBig", 
	{
		font		= "Dirty Ego",
		size		= Clockwork.kernel:FontScreenScale(24),
		weight		= 600,
...
function THEME:Initialize()
	...
	--Clockwork.option:SetColor( "white", Color(200, 200, 200, 255) );
	Clockwork.option:SetFont("bar_text", "hlc_TargetIDText");
	Clockwork.option:SetFont("main_text", "hlc_MainText");
	Clockwork.option:SetFont("hints_text", "hlc_IntroTextTiny");
	Clockwork.option:SetFont("large_3d_2d", "hlc_Large3D2D");
	Clockwork.option:SetFont("menu_text_big", "hlc_MenuTextBig");
	Clockwork.option:SetFont("menu_text_huge", "hlc_MenuTextHuge");
	Clockwork.option:SetFont("target_id_text", "hlc_TargetIDText");
	Clockwork.option:SetFont("cinematic_text", "hlc_CinematicText");
	Clockwork.option:SetFont("date_time_text", "hlc_IntroTextSmall");
	Clockwork.option:SetFont("intro_text_big", "hlc_IntroTextBig");
	Clockwork.option:SetFont("menu_text_tiny", "hlc_IntroTextTiny");
	Clockwork.option:SetFont("menu_text_small", "hlc_IntroTextSmall");
	Clockwork.option:SetFont("intro_text_tiny", "hlc_IntroTextTiny");
	Clockwork.option:SetFont("intro_text_small", "hlc_IntroTextSmall");
	Clockwork.option:SetFont("player_info_text", "hlc_PlayerInfoText");
end;

local DIRTY_TEXTURE = Material("hlc/dirty.png");
local SCRATCH_TEXTURE = Material("hlc/scratch.png");
...
THEME.skin.fontCategoryHeader = "hlc_ThickArial";
THEME.skin.fontMenuOption = "hlc_ThickArial";
THEME.skin.fontFormLabel = "hlc_ThickArial";
THEME.skin.fontButton = "hlc_ThickArial";
THEME.skin.fontFrame = "hlc_ThickArial";
THEME.skin.fontTab = "hlc_ThickArial";
